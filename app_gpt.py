...
def app():
    ...
    webrtc_streamer = webStreamer(key="camera", type="video",
                                  source=webrtc.VideoTransformerBase(fps=24,transform_func=lambda frame: cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)))
